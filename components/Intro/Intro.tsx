  ...
  return (
    <section className={styles.intro} id="about" aria-labelledby="intro-heading">
      <div className={styles.text}>
        <p className={styles.eyebrow}>Field notes from the road</p>
        <h1 id="intro-heading" className={styles.heading}>
          I go places
          <br />
          and write it <span className={styles.accent}>down.</span>
        </h1>
        <p className={styles.lede}>
          Hi, I&apos;m Sam. This is where I keep the photos and stories from my
      ...
      <div className={styles.portrait}>
        ...
        <span className={styles.badge}>Somewhere, right now</span>
      </div>
    </section>
  )
}
